//Bookmark this on your school pc for easier way to inject, by copying the code and putting it in there for url
...
(async () => {
    ...
    if (console.log("%c Hallo's Exploits! %c\n	by hallo org on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/randomstuff69/blooketcheatsplus", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            id: "variables",
            innerHTML: `:root {--backgroundColor: ${c.data?.theme?.backgroundColor || "rgba(85, 85, 85, 1)"};--infoColor: ${c.data?.theme?.infoColor || "#2c2c2cff"};--cheatList: ${c.data?.theme?.cheatList || "#202020ff"};--defaultButton: ${c.data?.theme?.defaultButton || "#2c2c2cff"};--disabledButton: ${c.data?.theme?.disabledButton || "#A02626"};--enabledButton: ${c.data?.theme?.enabledButton || "#47A547"};--textColor: ${c.data?.theme?.textColor || "white"};--inputColor: ${c.data?.theme?.inputColor || "#222222ff"};--contentBackground: ${c.data?.theme?.contentBackground || "rgba(37, 37, 37, 1)"};}`
        }), l("style", {
            ...
            inputs: [{
                ...
                options: [{
                    ...
                    value: {
                        ...
                        infoColor: "#272727ff",
                        cheatList: "#272727ff",
                        defaultButton: "#363636ff",
                        disabledButton: "#A02626",
                        enabledButton: "#47A547",
                        textColor: "white",
                        inputColor: "#272727ff",
                        contentBackground: "rgba(22, 22, 22, 1)"
                    }
                }, {
                    ...
                    value: {
                        backgroundColor: "linear-gradient(162.5deg, rgba(90, 90, 90, 1) 220px, rgba(65, 65, 65, 1) 100%)"
                    }
                }, {
